...
declare namespace $ {
    class $hyoo_meme extends $mol_page {
        ...
        tools(): readonly any[];
        body(): readonly any[];
        Frame(index: any): $$.$hyoo_meme_frame;
        ...
        frames(): readonly any[];
        Frames(): $$.$mol_list;
        frame_data(index: any, val?: any): {
            back: string;
            before: string;
            inside: string;
            after: string;
        };
        frame_drop(index: any, event?: any): any;
        Frame_drop_icon(index: any): $mol_icon_cross;
        Frame_drop(index: any): $mol_button_minor;
        frame_tools(index: any): readonly any[];
    }
}
