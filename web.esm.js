...
(function ($) {
    class $hyoo_meme extends $.$mol_page {
        ...
        Frame(index) {
            ...
            obj.data = (val) => this.frame_data(index, val);
            obj.tools = () => this.frame_tools(index);
            return obj;
        }
        Theme() {
        ...
        frame_drop(index, event) {
            if (event !== undefined)
                return event;
            return null;
        }
        Frame_drop_icon(index) {
            const obj = new this.$.$mol_icon_cross();
            return obj;
        }
        Frame_drop(index) {
            const obj = new this.$.$mol_button_minor();
            obj.click = (event) => this.frame_drop(index, event);
            obj.sub = () => [
                this.Frame_drop_icon(index)
            ];
            return obj;
        }
        frame_tools(index) {
            return [
                this.Frame_drop(index)
            ];
        }
    }
    __decorate([
...
(function ($) {
    var $$;
    (function ($$) {
        const load = $.$mol_fiber_sync((blob) => new Promise((done, fail) => {
